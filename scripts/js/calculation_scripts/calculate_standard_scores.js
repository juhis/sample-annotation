/**
  ...
  * Purpose: This script transforms the values in a matrix to standard scores by giving each row a mean of 0 and a standard deviation of 1, and writes it to a new file.
  */
...
if (process.argv.length !== 4) {
	...
	console.log('Usage: node calculate_standard_scores.js input output.txt')
	process.exit(1);
}
...
/**
  * Calculates the standard scores.
  */
...
/**
  * Prints the run time of the script when streaming is done.
  */
function end() {
...
/**
  * Transfers Date().getTime() to hours, minutes and seconds.
  */
